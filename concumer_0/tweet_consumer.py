...
class TweetsConsumer():
    ...
    def __init__(self, host="localhost", port="9092", topic_name="test"):
        self.consumer = KafkaConsumer(topic_name, bootstrap_servers=[host+":"+port],auto_offset_reset='latest', enable_auto_commit=True, value_deserializer = lambda m: json.loads(m.decode('utf-8')))
