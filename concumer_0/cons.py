...
flower_df1 = tweet_df.selectExpr("CAST(value AS STRING)", "timestamp")



flower_schema_string = "id STRING, timestamp STRING, coordinates STRING, text STRING, retweet_count INT, followers_count INT"



flower_df2 = flower_df1 \
    .select(from_csv(col("id"), flower_schema_string) \
